...
int main(int argc, char** argv) {
    ...
    require(actions.find("native.SetGiven(false)")!=std::string::npos);
    require(actions.find("Quest accepted: ")!=std::string::npos);
    require(loader.find("Client_DisplayTextNotification")!=std::string::npos);
    require(loader.find("request.ToastAttempts<4")!=std::string::npos);
