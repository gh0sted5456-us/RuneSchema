...
int main(){
    Check(Width==960&&Height==720,"compact logical panel");Model m;m.Update(Fixture());CheckGeometry(m);
    ...
    Check(tiles==12,"three-by-four item grid retained");Check(gold&&ash,"gold frame and opaque ash-black fill");
    Click(m,"tab","1");Click(m,"node-subtab","1");m.Activate("scroll-end");Check(m.scroll[1]==10,"last page of every discovered AI is reachable");
