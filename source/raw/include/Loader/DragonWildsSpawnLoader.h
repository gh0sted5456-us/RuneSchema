...
namespace DragonWilds {
    class DragonWildsSpawnLoader : public DragonWildsModLoaderBase {
        ...
        struct SpawnInfo {
            ...
            nlohmann::json AssemblyPieces=nlohmann::json::array();
    ...
    public:
        ...
        void LoadBuildingPlacements(const nlohmann::json& data,const RC::StringType& modName){LoadSpawns(data,modName);}
    ...
    private:
        ...
        struct PendingClientVisual {
            RC::StringType ActorPath;
            RC::StringType ModName;
            RC::StringType EntryId;
            unsigned Attempts=0;
        };
        std::vector<PendingClientVisual> m_pendingClientVisuals;
        double m_clientVisualElapsed=0.0;
        ...
        void RegisterStaticAssembly(SpawnInfo& spawn, const nlohmann::json& value);
        ...
        void PumpClientSpawnVisuals(double deltaSeconds);
        ...
        void ProcessStaticAssemblyEntry(RC::Unreal::UWorld* world, SpawnInfo& spawn);
        void ProcessClientStaticAssemblies(RC::Unreal::UWorld* world,
        ...
        void CreateStaticAssembly(RC::Unreal::UWorld* world, SpawnInfo& spawn);
