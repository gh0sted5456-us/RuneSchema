# RuneSchema 0.6.1 Experimental — Sizing Sneasel

This branch is the community testing line for changes that have not been merged into the official RuneSchema release. It is based on the upstream `main` branch and identifies itself at runtime as `0.6.1 Experimental`.
