    ...
    RegistryContext ResolveRegistry(UObject* object)
    {
        ...
        for (const auto& binding : RegistryBindings)
        {
            ...
            if (result.Subsystem)
            {
                ...
                result.PersistenceMapProperty = DragonWilds::PropertyHelper::CastProperty<FMapProperty>(
                    DragonWilds::PropertyHelper::GetPropertyByName(
                        subsystemObjectClass, TEXT("PersistenceIDToDataMap")));
                result.InternalNameMapProperty = DragonWilds::PropertyHelper::CastProperty<FMapProperty>(
                    DragonWilds::PropertyHelper::GetPropertyByName(
...
namespace DragonWilds {
        ...
        bool allowPropertiesContainer)
    {
        ...
        {
            field.Property = PropertyHelper::CastProperty<FStrProperty>(
