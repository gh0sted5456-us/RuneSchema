        ...
        if (BeginRuneSchemaTab("Authoring & Tools", TabRole::Diagnostics)) {
            ...
            if(selectedTool==5)PS::SaveViewer::RenderCleanup();
                ...
                if(authoringPage==0) {
                    ...
                    ImGui::TextWrapped("Activity counters and semantic signals from quests, events, vendors, recipes, buildings, and gathering are the next runtime phase; this checkpoint does not write unsupported counter fields.");
